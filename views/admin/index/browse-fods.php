...
$cells = (iterator_count(loop('HistoryLogEntry')) + ($params['exportheaders'] ? 1 : 0)) * count($headers);
...
<?php echo $this->partial('ods/meta.php', $options); ?>
<?php echo $this->partial('ods/settings.php', $options); ?>
 <office:scripts/>
<?php echo $this->partial('ods/styles.php', $options); ?>
