...
<div class="element-set">
  ...
  <?php
            if ($showElementSetHeadings):
?>
    <h2><?php
                echo html_escape(__($setName));
?></h2>
  <?php
            endif;
?>
...
<?php
     ...
     *
     * @param string $type the slug of the type of action associated with this
     * value parameter
     * @param string $dbValue The "value" parameter directly from the database
